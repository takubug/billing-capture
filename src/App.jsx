...
No markdown, no explanation, just the JSON object. Report the name in the format Suranme, First name. The insurer will follow the letters PVT and the Insurance number is the string of characters immediately following that. Convert the address from all capitals to sentence case.`,
            },
          ],
        },
      ],
