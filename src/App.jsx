...
const DRIVE_FOLDER_NAME = "BillingCapture";
        ...
        <div style={styles.modal}>
          <div style={styles.modalBox}>
            ...
            <p style={styles.modalText}>
              ...
              with Sheets, Gmail, Drive, and OAuth APIs enabled, and this page's URL as an authorised redirect URI.
            </p>
            <input
              style={styles.input}
        ...
        {step === "review" && (
          <div style={styles.card}>
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 16 }}>
              <button style={{ ...styles.btn, background: "#555", flex: 1 }} onClick={() => { setStep("capture"); setImagePreview(null); setImageFile(null); setFields(EMPTY_FIELDS); }}>
                ← Back
              </button>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.fieldGroup}>
              ...
              <p style={styles.hint}>
                ...
                . Enable Google Sheets API, Gmail API, Google Drive API, and Google OAuth. Add this page's URL as a redirect URI.
              </p>
            </div>
            <div style={styles.fieldGroup}>
            ...
            <div style={{ marginTop: 24, padding: 16, background: "#1a1a2e", borderRadius: 10, fontSize: 13, color: "#aaa", lineHeight: 1.7 }}>
              ...
              <ol style={{ paddingLeft: 18, margin: "8px 0 0" }}>
                ...
                <li>Paste Client ID above → Save → Re-authenticate Google</li>
              </ol>
            </div>
          </div>
        )}
